Edit Penilaian<div class="page-header">
  <h3>Edit penilaian</h3>
</div>
<?php foreach ($nilai_ikm as $a){ ?>
<form action="<?php echo base_url().'admin/update_penilaian' ?>" form name="page" method="post" enctype="multipart/form-data">

  <div class="form-group">
    <label>KBLI</label>
      <input type="hidden" name="id_ikm" value="<?php echo $a->id_ikm; ?>">
    <input type="text" name="kbli" class="form-control"  value="<?php echo $a->kbli; ?>"readonly>
  ...
  <div class="form-group">
    ...
    <select name="prov" class="form-control">
      <option value="<?php echo $a->prov; ?>"><?php echo $a->prov; ?></option>
  ...
  <div class="form-group">
    ...
    <select name="kab" class="form-control">
      <option value="<?php echo $a->kab; ?>"><?php echo $a->kab; ?></option>
  ...
  <div class="form-group">
    ...
    <select name="kec" class="form-control">
      <option value="<?php echo $a->kec; ?>"><?php echo $a->kec; ?></option>
  ...
  <div class="form-group">
    ...
    <select name="desa" class="form-control">
      <option value="<?php echo $a->desa; ?>"><?php echo $a->desa; ?></option>
    </select>
    ...
    <div class="form-group">
      ...
      <select name="suplier" class="form-control">
        <option value="<?php echo $a->suplier; ?>"><?php echo $a->suplier; ?></option>
    ...
    <div class="form-group">
      ...
      <select name="legal" class="form-control">
        <option value="<?php echo $a->legal; ?>"><?php echo $a->legal; ?></option>
    ...
    <div class="form-group">
      ...
      <select name="kontinuitas" class="form-control">
        <option value="<?php echo $a->kontinuitas; ?>"><?php echo $a->kontinuitas; ?></option>
    ...
    <div class="form-group">
      ...
      <select name="pangsa" class="form-control">
        <option value="<?php echo $a->pangsa; ?>"><?php echo $a->pangsa; ?></option>
    ...
    <div class="form-group">
      ...
      <select name="kompetensi" class="form-control">
        <option value="<?php echo $a->kompetensi; ?>"><?php echo $a->kompetensi; ?></option>
    ...
    <div class="form-group">
      ...
      <select name="jtk" class="form-control">
        <option value="<?php echo $a->jtk; ?>"><?php echo $a->jtk; ?></option>
    ...
    <div class="form-group">
      ...
      <select name="produksi" class="form-control">
        <option value="<?php echo $a->produksi; ?>"><?php echo $a->produksi; ?></option>
    ...
    <div class="form-group">
      ...
      <select name="adm" class="form-control">
        <option value="<?php echo $a->adm; ?>"><?php echo $a->adm; ?></option>
    ...
    <div class="form-group">
      <label>Nilai</label>
      <input type="text" name="nilai" class="form-control" value="<?php echo $a->nilai; ?>"readonly>
      <?php echo form_error('nilai'); ?>
    </div>

    <div class="form-group">
      <label>Level</label>
      <input type="text" name="level" class="form-control" value="<?php echo $a->level; ?>"readonly>
